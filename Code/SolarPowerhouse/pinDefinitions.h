...
constexpr static uint8_t K1_INVERTER_DC = 4; // Relay for Inverter DC
constexpr static uint8_t K2_INVERTER_AC = 5; // Relay for Inverter AC
constexpr static uint8_t K3_MPPT_CHARGER = 6; // Relay for MPPT Charger
constexpr static uint8_t K4_FANS = 7; 
constexpr static uint8_t TFT_SD_CS = 13; // TFT SD Card Chip Select
